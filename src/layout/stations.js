...
const RAW = [
  ...
  {
    id: 'immunoassay1', name: 'Immunoassay 1', short: 'Immunoassay 1', domain: 'immunoassay',
    type: 'analyzer', x: 120, w: 13, d: 8.5, h: 3.8, mount: 'spur', spur: 4.5, units: 1, hoods: true,
    models: ['DxI 3'],
    desc: 'First immunoassay cell (DxI 3) running hormone, cardiac and tumor-marker panels. Branches off the spine at 90°.',
    meta: ['DxI 3', 'Chemiluminescence'],
    stats: [['Throughput', '~400 tests/hr'], ['Method', 'Chemiluminescence'], ['Cells', 'DxI 3']],
  },
  {
    id: 'immunoassay2', name: 'Immunoassay 2', short: 'Immunoassay 2', domain: 'immunoassay',
    type: 'analyzer', x: 138.5, w: 18, d: 8.5, h: 3.8, mount: 'spur', spur: 4.5, units: 2, hoods: true,
    models: ['DxI 1', 'DxI 2'],
    desc: 'Second immunoassay cell (DxI 1 & 2) running infectious-disease and endocrine panels on its own 90° spur.',
    meta: ['DxI 1 & 2', 'Chemiluminescence'],
    stats: [['Throughput', '~800 tests/hr'], ['Method', 'Chemiluminescence'], ['Cells', 'DxI 1 · DxI 2']],
  },
  {
    id: 'sms2', name: 'SMS', short: 'SMS', domain: 'sms',
    type: 'sms', x: 153.75, w: 6.5, d: 5, h: 2.9, mount: 'spine',
  ...
  },
  {
    ...
    type: 'analyzer', x: 168, w: 16, d: 14, h: 3.9, mount: 'spur', spur: 4.5,
  ...
  },
  {
    ...
    type: 'command', x: 186, w: 7, d: 3.6, h: 2.6, mount: 'desk',
  ...
  },
  {
    ...
    type: 'outlet', x: 184, w: 10, d: 6, h: 3.2, mount: 'spine',
  ...
  },
  {
    ...
    type: 'decapper', x: 196, w: 8, d: 5.5, h: 3.1, mount: 'spine',
  ...
  },
  {
    ...
    type: 'recapper', x: 207.5, w: 9, d: 6, h: 3.2, mount: 'spine',
  ...
  },
  {
    ...
    type: 'stockyards', x: 223, w: 16, d: 8, h: 4.3, mount: 'spur', spur: 4, units: 1,
